    ...
    return (
        <Grid container spacing={2}
            ...
            <Grid item xs={12}>
                ...
                {Template.PRWE.slice(0, 5).map((d, i) => <Grid item xs container direction="row" spacing="1" alignItems="center">
                        <Grid item xs={8}>{d}</Grid>
                        <Grid item xs={4}>
                ...
                <h4 className={classes.subheader}>Single Answer Numeric Evaluation SANE (adapted to hand and wrist / hand) </h4>
                <Grid item xs container direction="row" spacing="1" alignItems="center">
